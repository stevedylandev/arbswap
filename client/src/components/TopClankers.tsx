...
export function TopClankers({
        ...
        try {
          ...
          if (swapAmounts) {
            const tradeData: TradeData = {
              ...
              token_address_out: pendingToken.address,
    ...
    return (
      <div className="w-full max-w-md mx-auto p-6 bg-background border rounded-lg shadow-sm">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          The current top Clankers based on your mutual follows on Farcaster. Click any token to
          swap for it!
        </p>
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-background border rounded-lg shadow-sm">
      <h2 className="text-2xl font-bold">Top Clankers on Arbitrum</h2>
      <p className="text-sm text-muted-foreground mb-6">
        The current top Clankers based on your mutual follows on Farcaster. Click any token to swap
        for it!
      </p>
        ...
        {topThree.map((token, index) => (
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <div className="font-semibold text-lg truncate">{token.name}</div>
